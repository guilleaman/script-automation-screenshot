...
# Configurações do Selenium e do Chrome para emular um dispositivo móvel
chrome_options = Options()
chrome_options.add_argument("--window-size=412,915")  # Tamanho da tela do Samsung Galaxy S20
chrome_options.add_argument("--user-agent=Mozilla/5.0 (Linux; Android 11; SM-G980F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Mobile Safari/537.36")  # User-agent do Chrome mobile
...
for index, url in enumerate(urls):
    ...
    screenshot_file = os.path.join(output_folder, f'screenshot_mobile_{index + 1}.png')
